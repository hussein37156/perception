...
from perception.msg import Multi_instance
from hardware.msg import Sonar  # Assuming Sonar is a custom message type for sonar data
# Global variables
latest_sonar = None
...
def estimated_callback(msg):
    ...
    for i, landmark in enumerate(msg.data):
        latest_estimated = landmark.z
...
if __name__ == '__main__':
    ...
    rospy.Subscriber('/sonar/ping1d/forward', Sonar, sonar_callback)
    rospy.Subscriber('/landmarks', Multi_instance, estimated_callback)
