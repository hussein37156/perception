...
def init():
    ...
    rospy.Subscriber("/zed/zed_node/left_raw/image_raw_color", Image, left_image_call_back)
    rospy.Subscriber("/zed/zed_node/right_raw/image_raw_color", Image, right_image_call_back)
